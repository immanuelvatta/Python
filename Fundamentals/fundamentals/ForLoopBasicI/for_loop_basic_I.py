...
print(f"Sum of all odd integers from 0 to 500,000 is: {sum}")
...
# through highNum, print only the integers that are a multiple of mult. For example, if lowNum=2, highNum=9, 
